...
/**
 * ACIDE - A Configurable IDE graph zoom out button listener.
 * 
 * @see ActionListener
 */
public class AcideGraphPanelZoomOutListener implements ActionListener {
	/*
	 * (non-Javadoc)
	...
	public void actionPerformed(ActionEvent arg0) {
		//decrease the zoom of the graphs and updates the image.
		 if(AcideGraphPanel._canvas!=null)
			 AcideGraphPanel._canvas.zoomOut(CanvasPanel.Graph);
