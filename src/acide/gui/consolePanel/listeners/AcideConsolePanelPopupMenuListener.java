...
public class AcideConsolePanelPopupMenuListener extends MouseAdapter {
	...
	private void maybeShowPopup(MouseEvent mouseEvent) {
		...
		if (mouseEvent.isPopupTrigger()) {
			...
			if ((consolePanel.getTextPane().getSelectionStart() < consolePanel.getPromptCaretPosition()) ||
				(AcideMainWindow.getInstance().getFileEditorManager().getSelectedFileEditorPanel().getActiveTextEditionArea().getSelectedText()==null)	)
				consolePanel.getPopupMenu().getPasteMenuItem().setEnabled(false);
			else
