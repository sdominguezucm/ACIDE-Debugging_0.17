...
/**
 * <p>
 * ACIDE - A Configurable IDE console panel mouse wheel controller.
 * </p>
 * <p>
 ...
 * @version 0.11
 */
public class AcideConsolePanelMouseWheelController implements MouseWheelListener {
	 ...
	 */
	public AcideConsolePanelMouseWheelController(JScrollPane scrollPane) {
		this(scrollPane, 1);
	}
	 ...
	 *            the scroll pane being used by the mouse wheel
	 */
	public AcideConsolePanelMouseWheelController(JScrollPane scrollPane, int scrollAmount) {
	...
	private void fontZoom(MouseWheelEvent mouseWheelEvent) {
		...
		AcideResourceManager.getInstance().setProperty(
				...
				String.valueOf(AcideMainWindow
						.getInstance()
