...
//			int prueba = AcideMainWindow.getInstance().getConsolePanel().getTextPane().getDocument().getLength();
//			int prueba2 = AcideMainWindow.getInstance().getConsolePanel().getContent().length();
//			
//			processChangedLines(0, prueba2);
