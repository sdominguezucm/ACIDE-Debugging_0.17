 ...
 * @version 0.16
 */
public class AcideDebugPanelNodeShapeMenu extends JMenu {
	...
	public AcideDebugPanelNodeShapeMenu(){
	...
	public void setListeners(){
		...
		_nodeShapeCircleMenuItem.addActionListener(new AcideInsertedItemListener(
				...
				.getSubmenu(AcideConfigurationMenu.CONFIGURATION_MENU_NAME)
				.getSubmenu(AcideDebugPanelMenu.DEBUG_MENU_NAME)
				.getSubmenu(AcideDebugPanelNodeShapeMenu.NODE_SHAPE_MENU_NAME)
