 ...
 * @version 0.16
 */
public class AcideDebugPanelNodeShapeSquareMenuItemListener implements ActionListener {
	...
	public static void action(ActionEvent actionEvent){
		...
		AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getCanvas().setNodeShape(AcideGraphCanvas.NODE_SQUARE);
