 ...
 * @version 0.16
 */
public class AcideDebugPanelArrowColorDirectMenuItemListener implements
		ActionListener {
	...
	public static void action(ActionEvent actionEvent){
		...
		if(c!=null){
			...
			AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getCanvas().setLinkColor1(c);
