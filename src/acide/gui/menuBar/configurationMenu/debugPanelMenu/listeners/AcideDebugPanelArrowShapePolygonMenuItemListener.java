...
/**
 * ACIDE - A Configurable IDE debug panel arrow shape polygon menu item listener.
 * 
 * @see ActionListener
 * @version 0.16
 */
public class AcideDebugPanelArrowShapePolygonMenuItemListener implements ActionListener {
	/*
	 * (non-Javadoc)
	...
	public static void action(ActionEvent actionEvent){
		...
		AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getCanvas().setArrowShape(AcideGraphCanvas.ARROW_POLYGON);
