...
/**
 * ACIDE - A Configurable IDE node color menu item listener.
 * 
 * @see ActionListener
 * @version 0.16
 */
public class AcideDebugPanelNodeColorItemMenuItemListener implements ActionListener {
	/*
	 * (non-Javadoc)
	...
	public static void action(ActionEvent actionEvent){
		...
		if(c!=null){
			AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getCanvas().setNodeColor(c);
