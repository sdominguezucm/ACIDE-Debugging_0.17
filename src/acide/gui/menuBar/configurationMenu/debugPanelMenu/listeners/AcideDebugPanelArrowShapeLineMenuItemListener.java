...
/**
 * ACIDE - A Configurable IDE debug panel arrow shape line menu item listener.
 * 
 * @see ActionListener
 * @version 0.16
 */
public class AcideDebugPanelArrowShapeLineMenuItemListener implements ActionListener{
	/*
	 * (non-Javadoc)
	...
	public static void action(ActionEvent actionEvent){
		...
		AcideMainWindow.getInstance().getDebugPanel().getTraceDatalogPanel().getCanvas().setArrowShape(AcideGraphCanvas.ARROW_LINE);
