...
public class AcideConsolePanelConfigurationPanel extends JPanel {
	 ...
	 *            ACIDE - A Configurable tool bar configuration window instance.
	 */
	public AcideConsolePanelConfigurationPanel(
		...
		// Stores the tool bar configuration window
	...
	private void showAcideAddToolBarCommandWindow() {
		...
		new AcideAddConsolePanelToolBarButtonWindow(_toolBarConfigurationWindow);
	}
