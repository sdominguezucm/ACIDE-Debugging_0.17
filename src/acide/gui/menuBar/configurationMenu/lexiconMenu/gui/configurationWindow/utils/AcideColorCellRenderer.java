 ...
 */
package acide.gui.menuBar.configurationMenu.lexiconMenu.gui.configurationWindow.utils;
 ...
 */
public class AcideColorCellRenderer extends JLabel implements TableCellRenderer {
	/**
	 ...
	 *            is bordered flag
	 */
	public AcideColorCellRenderer(boolean isBordered) {
