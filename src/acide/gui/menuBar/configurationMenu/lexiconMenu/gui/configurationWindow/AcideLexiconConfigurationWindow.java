...
public class AcideLexiconConfigurationWindow extends JFrame {
	...
	private void setListeners() {
		...
		_saveAsButton.addActionListener(new SaveLexiconAsButtonAction());
	...
	private void applyChanges() {
		...
		AcideMainWindow
				...
				.getSelectedFileEditorPanel()
				.getLexiconConfiguration()
				.load(AcideMainWindow.getInstance().getFileEditorManager()
						.getSelectedFileEditorPanel().getLexiconConfiguration()
						.getPath());
	 ...
	 * @see ActionListener
	 */
	class SaveLexiconAsButtonAction implements ActionListener {
	...
	/**
	 * ACIDE - A Configurable IDE lexicon configuration window escape key
	 * action.
	 * 
	 * @version 0.11
	 * @see AbstractAction
