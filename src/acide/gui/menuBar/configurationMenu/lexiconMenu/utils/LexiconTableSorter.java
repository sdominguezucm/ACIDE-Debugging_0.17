...
public class LexiconTableSorter extends LexiconTableMap {
	...
	public int compareRowsByColumn(int row1, int row2, int column) {
		...
		if (o1 == null && o2 == null) {
			...
			// Defines null less than everything
			return -1;
		} else if (o2 == null) {
			return 1;
		}
	...
	public void reallocateIndexes() {
		...
		// Sets up a new array of indexes with the right number of elements for
		// the data model
		_indexes = new int[rowCount];

		// Initializes with the identity mapping
	 ...
	 * 
	 * @see
	 * gui.menuBar.configurationMenu.lexiconMenu.utils.LexiconTableMap#tableChanged
