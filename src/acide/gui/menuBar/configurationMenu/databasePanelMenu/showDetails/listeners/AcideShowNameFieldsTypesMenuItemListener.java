...
/**
 * ACIDE - A Configurable IDE Name Fields types menu item listener.
 * 
 * @version 0.14
 * @see ActionListener
 */
public class AcideShowNameFieldsTypesMenuItemListener implements ActionListener{
	...
	public static void action(ActionEvent event) {
		...
		AcideMainWindow.getInstance().getMenu().getConfigurationMenu()
		.getDatabasePanelMenu().getShowDetailsMenu().getNameFieldsTypesMenuItem().setSelected(true);
		AcideDataBasePanelTablesPopupMenu.getInstance().getShowDetails().getNameFieldsTypesMenuItem().setSelected(true);
		AcideDataBasePanelViewsPopupMenu.getInstance().getShowDetails().getNameFieldsTypesMenuItem().setSelected(true);
		panel.setNameFieldsTypesTables(true);
