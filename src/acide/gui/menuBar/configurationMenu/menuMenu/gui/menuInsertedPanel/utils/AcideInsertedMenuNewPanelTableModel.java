 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.menuInsertedPanel.utils;
...
/**
 * ACIDE - A Configurable IDE inserted menu new panel table model.
 * 
 * @version 0.11
 * @see DefaultTableModel
 */
public class AcideInsertedMenuNewPanelTableModel extends
DefaultTableModel  {
	/**
	 * ACIDE - A Configurable IDE inserted menu panel new configuration panel table model
	...
	/**
	 * ACIDE - A Configurable IDE inserted menu panel configuration panel table model
	 * item list.
	 */
	private ArrayList<AcideMenuObjectConfigurationWithNumber> _items;
	/**
	 * ACIDE - A Configurable IDE inserted menu panel new configuration panel instance.
	 */
	private AcideMenuInsertedPanel _insertedMenuPanelNewConfigurationPanel;
	
	/**
	 * Creates a new ACIDE - A Configurable IDE inserted menu panel new configuration
	 * panel table model.
	 * 
	 * @param insertedMenuPanelNewConfigurationPanel
	 *            <p>
	 ...
	 *            </p>
	 */
	public AcideInsertedMenuNewPanelTableModel(
			AcideMenuInsertedPanel insertedMenuPanelNewConfigurationPanel) {

		// Stores the inserted menu configuration panel instance
		_insertedMenuPanelNewConfigurationPanel = insertedMenuPanelNewConfigurationPanel;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case COLUMN_PATH:
			String result = _insertedMenuPanelNewConfigurationPanel.getConfiguration().getName() + "/";
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		// panel
		_insertedMenuPanelNewConfigurationPanel.setAreThereChanges(true);
