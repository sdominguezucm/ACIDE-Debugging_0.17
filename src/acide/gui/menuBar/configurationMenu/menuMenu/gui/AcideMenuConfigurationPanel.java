 ...
 * @version 0.11
 */
public class AcideMenuConfigurationPanel extends JPanel {
	...
	/**
	 * ACIDE - A Configurable IDE menu configuration panel components.
	 */
	 ...
	 * 
	 * @param menu
	 *            menu option in the ACIDE - A Configurable IDE menu bar.
	 */
	public AcideMenuConfigurationPanel(JMenu menu) {
	...
	public void initComponents() {
		...
		for (int index = 0; index < _menu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu item from the menu
				menuItem = _menu.getItem(index);
				...
				// Gets the menu from the menu
				JMenu menu = (JMenu) _menu.getMenuComponent(index);
	...
	/**
	 * Adds the ACIDE - A Configurable IDE menu configuration panel information
	 * to the menu item list, based on the window check box values.
	 * 
	 * @param menuItemList
	...
	public void addFileMenuInformation(
		...
		for (int index = 0; index < AcideMainWindow.getInstance().getMenu()
				.getFileMenu().getItemCount(); index++) {
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE menu configuration
	 * panel components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE menu
