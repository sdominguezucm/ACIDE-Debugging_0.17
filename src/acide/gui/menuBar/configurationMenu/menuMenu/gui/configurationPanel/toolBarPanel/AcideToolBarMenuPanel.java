 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.toolBarPanel;
 ...
 * @see JPanel
 */
public class AcideToolBarMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE tool bar menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE tool bar menu panel tool bar menu instance.
	 */
	private AcideToolBarMenu _toolBarMenu = AcideMainWindow.getInstance().getMenu()
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE tool bar menu panel.
	 */
	public AcideToolBarMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE tool bar
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _toolBarMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the tool bar menu
				menuItem = _toolBarMenu.getItem(index);
				...
				JMenu menu = (JMenu) _toolBarMenu.getMenuComponent(index);
	...
	/**
	 * Adds the tool bar menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	...
	public void addToolBarMenuInformation(
		...
		for (int index = 0; index < _toolBarMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the tool bar menu
				JMenu menu = (JMenu) _toolBarMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE tool bar menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE tool bar menu panel
	 * components.
	 */
