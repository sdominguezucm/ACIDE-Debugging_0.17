 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.consolePanel;
 ...
 * @see JPanel
 */
public class AcideConsoleMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE console menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE console menu panel console menu instance.
	 */
	private AcideConsoleMenu _consoleMenu = AcideMainWindow.getInstance().getMenu()
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE console menu panel.
	 */
	public AcideConsoleMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE console
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _consoleMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the console menu
				menuItem = _consoleMenu.getItem(index);
				...
				JMenu menu = (JMenu) _consoleMenu.getMenuComponent(index);
	...
	/**
	 * Adds the console menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	 *            menu item list to be generated.
	 */
	public void addConsoleMenuInformation(
		...
		for (int index = 0; index < _consoleMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the console menu
				JMenu menu = (JMenu) _consoleMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE console menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE console menu panel
	 * components.
	 */
