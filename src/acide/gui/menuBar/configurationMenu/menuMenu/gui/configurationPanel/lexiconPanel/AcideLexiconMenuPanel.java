 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.lexiconPanel;
 ...
 * @see JPanel
 */
public class AcideLexiconMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE lexicon menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE lexicon menu panel lexicon menu instance.
	 */
	private AcideLexiconMenu _lexiconMenu = AcideMainWindow.getInstance().getMenu()
			.getConfigurationMenu().getLexiconMenu();
	/**
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE lexicon menu panel.
	 */
	public AcideLexiconMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE lexicon
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _lexiconMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the lexicon menu
				menuItem = _lexiconMenu.getItem(index);
				...
				JMenu menu = (JMenu) _lexiconMenu.getMenuComponent(index);
	...
	/**
	 * Adds the lexicon menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	...
	public void addLexiconMenuInformation(
		...
		for (int index = 0; index < _lexiconMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the lexicon menu
				JMenu menu = (JMenu) _lexiconMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE lexicon menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE lexicon menu panel
	 * components.
	 */
