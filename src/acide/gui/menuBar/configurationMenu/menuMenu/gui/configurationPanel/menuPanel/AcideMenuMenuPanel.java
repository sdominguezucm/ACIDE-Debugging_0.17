 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.menuPanel;
 ...
 * @see JPanel
 */
public class AcideMenuMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE menu menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE menu menu panel menu menu instance.
	 */
	private AcideMenuMenu _menuMenu = AcideMainWindow.getInstance().getMenu()
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE menu menu panel.
	 */
	public AcideMenuMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE menu
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _menuMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the menu menu
				menuItem = _menuMenu.getItem(index);
				...
				JMenu menu = (JMenu) _menuMenu.getMenuComponent(index);
	...
	public void addMenuMenuInformation(
		...
		for (int index = 0; index < _menuMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the menu menu
				JMenu menu = (JMenu) _menuMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE menu menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE menu menu panel
	 * components.
	 */
