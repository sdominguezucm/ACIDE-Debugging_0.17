 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.fileEditorPanel;
 ...
 * @see JPanel
 */
public class AcideFileEditorMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE file editor menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE file editor menu panel file editor menu instance.
	 */
	private AcideFileEditorMenu _fileEditorMenu = AcideMainWindow.getInstance().getMenu()
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE file editor menu panel.
	 */
	public AcideFileEditorMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE file editor
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _fileEditorMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the file editor menu
				menuItem = _fileEditorMenu.getItem(index);
				...
				JMenu menu = (JMenu) _fileEditorMenu.getMenuComponent(index);
	...
	/**
	 * Adds the file editor menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	...
	public void addFileEditorMenuInformation(
		...
		for (int index = 0; index < _fileEditorMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the file editor menu
				JMenu menu = (JMenu) _fileEditorMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE file editor menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE file editor menu panel
	 * components.
	 */
