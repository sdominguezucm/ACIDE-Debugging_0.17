 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.grammarPanel;
 ...
 * @see JPanel
 */
public class AcideGrammarMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE grammar menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE grammar menu panel grammar menu instance.
	 */
	private AcideGrammarMenu _grammarMenu = AcideMainWindow.getInstance().getMenu()
			.getConfigurationMenu().getGrammarMenu();
	/**
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE grammar menu panel.
	 */
	public AcideGrammarMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE grammar
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _grammarMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the grammar menu
				menuItem = _grammarMenu.getItem(index);
				...
				JMenu menu = (JMenu) _grammarMenu.getMenuComponent(index);
	...
	/**
	 * Adds the grammar menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	...
	public void addGrammarMenuInformation(
		...
		for (int index = 0; index < _grammarMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the grammar menu
				JMenu menu = (JMenu) _grammarMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE grammar menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE grammar menu panel
	 * components.
	 */
