 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.utils;
...
/**
 * ACIDE - A Configurable IDE configuration panel configuration panel table model.
 * 
 * @version 0.11
 * @see DefaultTableModel
 */
public class AcideConfigurationMenuNewPanelTableModel  extends
DefaultTableModel {
	/**
	 * ACIDE - A Configurable IDE configuration panel new configuration panel table model
	 ...
	 * ACIDE - A Configurable IDE configuration panel new configuration panel instance.
	 */
	private AcideConfigurationMenuNewPanel _configurationPanelNewConfigurationPanel;
	
	/**
	 * Creates a new ACIDE - A Configurable IDE configuration panel new configuration
	 * panel table model.
	 * 
	 * @param configurationPanelNewConfigurationPanel
	 *            <p>
	 *            ACIDE - A Configurable IDE configuration panel new configuration panel
	 *            instance.
	 *            </p>
	 *            <p>
	 ...
	 *            </p>
	 */
	public AcideConfigurationMenuNewPanelTableModel(
			AcideConfigurationMenuNewPanel configurationPanelNewConfigurationPanel) {

		// Stores the configuration menu configuration panel instance
		_configurationPanelNewConfigurationPanel = configurationPanelNewConfigurationPanel;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case COLUMN_PATH:
			String result = _configurationPanelNewConfigurationPanel.getConfiguration().getName() + "/";
	...
	public boolean isCellEditable(int row, int col) {
		...
		if ((name.equals(AcideMenuMenu.MENU_MENU_NAME)) || (name.equals(AcideMenuMenu.NEW_MENU_NAME))
				|| (name.equals(AcideMenuMenu.LOAD_MENU_NAME)) || (name.equals(AcideMenuMenu.MODIFY_MENU_NAME))
						|| (name.equals(AcideMenuMenu.SAVE_MENU_NAME)) || (name.equals(AcideMenuMenu.SAVE_MENU_AS_NAME)))
			return false;
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		// panel
		_configurationPanelNewConfigurationPanel.setAreThereChanges(true);
	...
	/**
	 * Returns the ACIDE - A Configurable IDE configuration panel new configuration panel
	 * table model item list.
	 * 
	 * @return the ACIDE - A Configurable IDE configuration panel new configuration panel
	 *         table model item list.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE configuration panel
