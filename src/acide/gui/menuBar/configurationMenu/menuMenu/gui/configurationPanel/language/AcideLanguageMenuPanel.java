 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.configurationPanel.language;
 ...
 * @see JPanel
 */
public class AcideLanguageMenuPanel extends JPanel {

	/**
	 * ACIDE - A Configurable IDE language menu panel serial version UID.
	 */
	private static final long serialVersionUID = 1L;
	/**
	 * ACIDE - A Configurable IDE language menu panel language menu instance.
	 */
	private AcideLanguageMenu _languageMenu = AcideMainWindow.getInstance().getMenu()
			.getConfigurationMenu().getLanguageMenu();
	/**
	...
	/**
	 * Creates a new ACIDE - A Configurable IDE language menu panel.
	 */
	public AcideLanguageMenuPanel() {
	...
	/**
	 * Builds and adds the components to the ACIDE - A Configurable IDE language
	 * menu panel.
	 */
	public void initComponents() {

		for (int index = 0; index < _languageMenu.getItemCount(); index++) {

			JMenuItem menuItem = null;
			try {

				// Gets the menu item from the language menu
				menuItem = _languageMenu.getItem(index);
				...
				JMenu menu = (JMenu) _languageMenu.getMenuComponent(index);
	...
	/**
	 * Adds the language menu information to the menu item list, based on the window
	 * check box values.
	 * 
	 * @param menuItemList
	...
	public void addLanguageMenuInformation(
		...
		for (int index = 0; index < _languageMenu.getItemCount(); index++) {
			...
			try {
				...
				// Gets the menu from the language menu
				JMenu menu = (JMenu) _languageMenu.getMenuComponent(index);
	...
	/**
	 * Marks as selected all the ACIDE - A Configurable IDE language menu panel
	 * components.
	 */
	...
	/**
	 * Marks as selected none of the ACIDE - A Configurable IDE language menu panel
	 * components.
	 */
