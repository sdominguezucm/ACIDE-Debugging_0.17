 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.helpPanel.utils;
...
/**
 * ACIDE - A Configurable IDE help panel configuration panel table model.
 * 
 * @version 0.11
 * @see DefaultTableModel
 */
public class AcideHelpMenuNewPanelTableModel  extends
DefaultTableModel {
	/**
	 * ACIDE - A Configurable IDE help panel new configuration panel table model
	 ...
	 * ACIDE - A Configurable IDE help panel new configuration panel instance.
	 */
	private AcideHelpMenuNewPanel _helpPanelNewConfigurationPanel;
	
	/**
	 * Creates a new ACIDE - A Configurable IDE help panel new configuration
	 * panel table model.
	 * 
	 * @param helpPanelNewConfigurationPanel
	 *            <p>
	 *            ACIDE - A Configurable IDE help panel new configuration panel
	 *            instance.
	 *            </p>
	 *            <p>
	 ...
	 *            </p>
	 */
	public AcideHelpMenuNewPanelTableModel(
			AcideHelpMenuNewPanel helpPanelNewConfigurationPanel) {

		// Stores the help help panel instance
		_helpPanelNewConfigurationPanel = helpPanelNewConfigurationPanel;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case COLUMN_PATH:
			String result = _helpPanelNewConfigurationPanel.getConfiguration().getName() + "/";
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		// panel
		_helpPanelNewConfigurationPanel.setAreThereChanges(true);
	...
	/**
	 * Returns the ACIDE - A Configurable IDE help panel new configuration panel
	 * table model item list.
	 * 
	 * @return the ACIDE - A Configurable IDE help panel new configuration panel
	 *         table model item list.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE help panel
