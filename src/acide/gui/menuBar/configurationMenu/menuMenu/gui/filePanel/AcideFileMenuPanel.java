	...
	public void selectNone() {
		...
		for (int index = 0; index < AcideMainWindow.getInstance().getMenu()
			...
			try {
				...
				// Gets the menu item from the file menu
				menuItem = AcideMainWindow.getInstance().getMenu()
						.getFileMenu().getItem(index);
				...
				// Gets the menu from the file menu
				JMenu menu = (JMenu) AcideMainWindow.getInstance().getMenu()
						.getFileMenu().getMenuComponent(index);
