 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.editPanel.utils;
...
/**
 * ACIDE - A Configurable IDE edit panel configuration panel table model.
 * 
 * @version 0.11
 * @see DefaultTableModel
 */
public class AcideEditMenuNewPanelTableModel extends
DefaultTableModel {
	
	/**
	 * ACIDE - A Configurable IDE edit panel new configuration panel table model
	 ...
	 * ACIDE - A Configurable IDE edit panel new configuration panel instance.
	 */
	private AcideEditMenuNewPanel _editPanelNewConfigurationPanel;
	
	/**
	 * Creates a new ACIDE - A Configurable IDE edit panel new configuration
	 * panel table model.
	 * 
	 * @param editPanelNewConfigurationPanel
	 *            <p>
	 *            ACIDE - A Configurable IDE edit panel new configuration panel
	 *            instance.
	 *            </p>
	 *            <p>
	 ...
	 *            </p>
	 */
	public AcideEditMenuNewPanelTableModel(
			AcideEditMenuNewPanel editPanelNewConfigurationPanel) {

		// Stores the console configuration panel instance
		_editPanelNewConfigurationPanel = editPanelNewConfigurationPanel;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case COLUMN_PATH:
			String result = _editPanelNewConfigurationPanel.getConfiguration().getName() + "/";
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		// panel
		_editPanelNewConfigurationPanel.setAreThereChanges(true);
