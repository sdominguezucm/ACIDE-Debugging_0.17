 ...
 */
package acide.gui.menuBar.configurationMenu.menuMenu.gui.viewPanel.utils;
...
/**
 * ACIDE - A Configurable IDE view panel configuration panel table model.
 * 
 * @version 0.11
 * @see DefaultTableModel
 */
public class AcideViewMenuNewPanelTableModel extends
DefaultTableModel {
	/**
	 * ACIDE - A Configurable IDE view panel new configuration panel table model
	 ...
	 * ACIDE - A Configurable IDE view panel new configuration panel instance.
	 */
	private AcideViewMenuNewPanel _viewPanelNewConfigurationPanel;
	
	/**
	 * Creates a new ACIDE - A Configurable IDE view panel new configuration
	 * panel table model.
	 * 
	 * @param viewPanelNewConfigurationPanel
	 *            <p>
	 *            ACIDE - A Configurable IDE view panel new configuration panel
	 *            instance.
	 *            </p>
	 *            <p>
	 ...
	 *            </p>
	 */
	public AcideViewMenuNewPanelTableModel(
			AcideViewMenuNewPanel viewPanelNewConfigurationPanel) {

		// Stores the menu configuration panel instance
		_viewPanelNewConfigurationPanel = viewPanelNewConfigurationPanel;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case COLUMN_PATH:
			String result = _viewPanelNewConfigurationPanel.getConfiguration().getName() + "/";
	...
	/**
	 * Returns the ACIDE - A Configurable IDE view menu new panel
	 * table model list of sons from an object.
	 * 
	 * @param ob
	 * 		the object whose soons we want to get
	 * @return the ACIDE - A Configurable IDE view menu new panel
	 * table model list of sons from an object.
	 */
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		// panel
		_viewPanelNewConfigurationPanel.setAreThereChanges(true);
	...
	/**
	 * Returns the ACIDE - A Configurable IDE view panel new configuration panel
	 * table model item list.
	 * 
	 * @return the ACIDE - A Configurable IDE view panel new configuration panel
	 *         table model item list.
	 */
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE view panel
