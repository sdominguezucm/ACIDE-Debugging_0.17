...
/**																
 * ACIDE - A Configurable IDE configure console display options menu item listener.											
 *					
 * @version 0.11
 * @see ActionListener																														
 */
public class AcideConsoleDisplayOptionsMenuItemListener implements ActionListener{
