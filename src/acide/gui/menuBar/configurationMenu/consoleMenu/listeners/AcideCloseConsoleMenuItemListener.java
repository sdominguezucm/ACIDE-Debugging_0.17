...
public class AcideCloseConsoleMenuItemListener implements ActionListener {
	...
	public static void action(ActionEvent actionEvent){
		...
		// Destroys the console process
		AcideMainWindow.getInstance().getConsolePanel().getProcessThread()._process.destroy();
		// Clears the console buffer
		AcideMainWindow.getInstance().getConsolePanel().clearAllConsoleBuffer();
