...
/**
 * ACIDE - A Configurable IDE arrow color direct menu item listener.
 * 
 * @see ActionListener
 */
public class AcideArrowColorDirectMenuItemListener implements ActionListener {
	/*
	 * (non-Javadoc)
	...
	public static void action(ActionEvent actionEvent){
		...
		if(c!=null){
			...
			AcideGraphCanvas.getInstance().setLinkColor1(c);
