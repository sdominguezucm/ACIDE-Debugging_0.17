...
/**
 * ACIDE - A Configurable IDE arrow color inverse menu item listener.
 * 
 * @see ActionListener
 */
public class AcideArrowColorInverseMenuItemListener  implements ActionListener {
	/*
	 * (non-Javadoc)
	...
	public static void action(ActionEvent actionEvent){
		...
		if(c!=null){
			...
			AcideGraphCanvas.getInstance().setLinkColor2(c);
