...
/**
 * ACIDE - A Configurable IDE show acide data base panel menu item listener.
 * 
 * @version 0.11
 * @see ActionListener
 */
public class AcideShowAcideDataBasePanelMenuItemListener implements
		ActionListener {
	...
	public static void action(ActionEvent arg0) {
		...
		if (AcideMainWindow.getInstance().getMenu().getViewMenu()
				.getShowDataBasePanelCheckBoxMenuItem().isSelected()) {
