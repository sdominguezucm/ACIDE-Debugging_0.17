 ...
 * @see ActionListener																													
 */
public class AcidePrintFileMenuItemListener implements ActionListener {
	...
	public static void action(ActionEvent actionEvent){
		...
		// Shows the print configuration window
		AcidePrintConfigurationWindow.getInstance().setVisible(true);
	}
}
