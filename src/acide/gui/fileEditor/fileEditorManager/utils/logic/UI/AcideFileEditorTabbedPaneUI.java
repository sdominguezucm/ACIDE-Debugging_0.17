...
public class AcideFileEditorTabbedPaneUI extends BasicTabbedPaneUI {
	 ...
	 *         parameter.
	 */
	public AcideFileEditorCloseButton getCloseButtonAt(int index) {
		return _tabbedPaneLayout.getCloseButtonAt(index);
	}
	...
	class AcideFileEditorTabbedPaneLayout extends TabbedPaneLayout {
		 ...
		 * 
		 * @param index
		 *            close button list index.
		 * 
		 * @return the close button from the list at the position given as a
		 *         parameter.
		 */
		public AcideFileEditorCloseButton getCloseButtonAt(int index) {
			return (AcideFileEditorCloseButton) _closeButtonList.get(index);
		}
