 ...
 */
public class AcideFileEditorManager extends JPanel {
	...
	/**
	 * ACIDE - A Configurable IDE file editor on focus.
	 */
	private int _fileEditorOnFocus;
	/**
	 * ACIDE - A Configurable IDE split container.
	 */
	...
	public int get_zoomActive() {
		return _zoomActive;
	}

	public void set_zoomActive(int _zoomActive) {
		this._zoomActive = _zoomActive;
	}
	
	public void dec_zoomActive(){
		_zoomActive--;
	}

	public void set_fileEditorOnFocus(int _fileEditorOnFocus) {
		this._fileEditorOnFocus = _fileEditorOnFocus;
	}

	public int get_fileEditorOnFocus() {
		return _fileEditorOnFocus;
	}
	...
	public void updateTabbedPane(String filePath, final String fileContent,
		...
		if (tabPosition == -1) {
			...
			getSelectedFileEditorPanel().getActiveTextEditionArea().requestFocusInWindow();
	...
	public String getNameEditorPanelAt(int index) {

				return((AcideFileEditorPanel) _tabbedPane
					.getComponentAt(index)).getFileNameWithExtension();
