...
import acide.gui.fileEditor.fileEditorPanel.popup.listeners.AcideLineWrappingMenuItemAction;
...
import acide.gui.fileEditor.fileEditorPanel.popup.listeners.AcideSendSelectedTextToConsoleMenuItemAction;
import acide.gui.fileEditor.fileEditorPanel.popup.listeners.AcideSendToConsoleConfirmationMenuItemAction;
...
public class AcideFileEditorPopupMenu extends JPopupMenu {
	 ...
	 * image icon.
	 */
	private  final static ImageIcon SEND_TO_CONSOLE_CONFIRMATION_IMAGE = new ImageIcon(
			"./resources/icons/menu/configuration/fileEditor/sendToConsoleConfirmation.png");
	/**
	...
	/**
	 * ACIDE - A Configurable IDE file editor panel popup menu send file selected text
	 * to console menu item.
	 */
	private JMenuItem _sendSelectedtextToConsoleMenuItem;
	/**
	 * ACIDE - A Configurable IDE file editor panel popup menu line wrapping
	 * menu item.
	 */
	private JCheckBoxMenuItem _lineWrappingCheckBoxMenuItem;
	
	/**
	 * ACIDE - A Configurable IDE file editor panel popup menu toogle comment
	 * menu item.
	 */
	private JMenuItem _toggleCommentMenuItem;
	
	/**
	 * ACIDE - A Configurable IDE file editor panel popup menu make comment
	 * menu item.
	 */
	private JMenuItem _makeCommentMenuItem;
	
	/**
	 * ACIDE - A Configurable IDE file editor panel popup menu release comment
	 * menu item.
	 */
	...
	private void addComponents() {
		...
		// Adds the toggle comment check box menu item to the popup menu
		add(_toggleCommentMenuItem);
		
		// Adds the make comment check box menu item to the popup menu
		add(_makeCommentMenuItem);
		
		// Adds the release comment check box menu item to the popup menu
		add(_releaseCommentMenuItem);
		
		// Adds a separator to the popup menu
		addSeparator();
		
		// Adds the line wrapping check box menu item to the popup menu
		...
		// Adds the send file content to console menu item to the popup menu
		add(_sendSelectedtextToConsoleMenuItem);
	...
	private void buildComponents() {
		...
		_lineWrappingCheckBoxMenuItem = new JCheckBoxMenuItem(
				AcideLanguageManager.getInstance().getLabels()
						.getString("s2014"), LINE_WRAPPING_IMAGE);
		...
		_sendToConsoleConfirmationMenuItem = new JCheckBoxMenuItem(
				AcideLanguageManager.getInstance().getLabels()
						.getString("s2103"), SEND_TO_CONSOLE_CONFIRMATION_IMAGE);
		...
		// Creates the file send file content menu item
				_sendSelectedtextToConsoleMenuItem = new JMenuItem(AcideLanguageManager
						.getInstance().getLabels().getString("s2022"), 
						SEND_FILE_CONTENT_TO_CONSOLE_IMAGE);
	...
	private void setListeners() {
		...
		// Sets the toggle menu item action listener
		_toggleCommentMenuItem
				.addActionListener(new AcideToggleCommentMenuItemListener());

		// Sets the make menu item action listener
		_makeCommentMenuItem
				.addActionListener(new AcideMakeCommentMenuItemListener());
				
		// Sets the release menu item action listener
		_releaseCommentMenuItem
				.addActionListener(new AcideReleaseCommentMenuItemListener());
		
		// Sets the line wrapping menu item action listener
		...
		_sendToConsoleConfirmationMenuItem
				.addActionListener(new AcideSendToConsoleConfirmationMenuItemAction());
		...
		// Sets the send file content to console menu item action listener
		_sendSelectedtextToConsoleMenuItem
				.addActionListener(new AcideSendSelectedTextToConsoleMenuItemAction());
	 ...
	 *         file content to console menu item.
	 */
	public JMenuItem getSenSelectedtextToConsoleMenuItem() {
		return _sendSelectedtextToConsoleMenuItem;
	}
	...
	/**
	 * Returns the ACIDE - A Configurable IDE file editor panel popup menu
	 * line wrapping check box menu item.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor panel popup menu
	 *         line wrapping check box menu item.
	 */
	public JMenuItem getLineWrappingCheckBoxMenuItem() {
	...
	/**
	 * Returns the ACIDE - A Configurable IDE file editor panel popup menu
	 * toggle comment checkbox menu item.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor panel popup menu
	 * 		toggle comment checkbox menu item.
	 */
	public JMenuItem getToggleCommentCheckBoxMenuItem() {
		return _toggleCommentMenuItem;
	}
	
	/**
	 * Returns the ACIDE - A Configurable IDE file editor panel popup menu
	 * make comment checkbox menu item.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor panel popup menu
	 * 		make comment checkbox menu item.
	 */
	...
	/**
	 * Returns the ACIDE - A Configurable IDE file editor panel popup menu
	 * release comment checkbox menu item.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor panel popup menu
	 * 		release comment checkbox menu item.
	 */
