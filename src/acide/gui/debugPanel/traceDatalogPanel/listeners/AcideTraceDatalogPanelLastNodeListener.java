...
/**
 * 
 * ACIDE - A Configurable IDE trace datalog last node listener.
 * 
 * @version 0.16
 * 
 */
public class AcideTraceDatalogPanelLastNodeListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			}while(selectedNodeIndex+1 < canvas.get_pathGraph().size());
			canvas.repaint();
