...
/**
 * ACIDE - A Configurable IDE trace datalog panel show labels listener.
 * 
 * @version 0.15
 * @see ActionListener
 */
public class AcideTraceDatalogPanelShowRulesListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		AcideDebugPanelHighLighter h = AcideMainWindow.getInstance()
				.getDebugPanel().getTraceDatalogPanel().getHighLighter();
		// Updates the highlights
		h.setHighlight(selected);
		h.unHighLight();
		h.highLight();
