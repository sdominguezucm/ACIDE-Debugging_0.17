 ...
 * @see ActionListener
 */
public class AcideAssertedDatabasePanelClearButtonListener  implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		AcideMainWindow.getInstance().getAssertedDatabasePanel().clearRenderer();
