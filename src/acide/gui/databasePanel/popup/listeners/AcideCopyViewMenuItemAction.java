...
/**
 * ACIDE - A Configurable IDE copy view action.
 * 
 * @version 0.13
 * @see ActionListener
 */
public class AcideCopyViewMenuItemAction implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		StringSelection name = new StringSelection(viewName);
		
		Clipboard cb = Toolkit.getDefaultToolkit().getSystemClipboard();

		cb.setContents(name, null);
	}
}