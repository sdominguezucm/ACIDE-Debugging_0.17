...
/**
 * ACIDE - A Configurable IDE tables hide details menu item action.
 * 
 * @version 0.13
 * @see ActionListener
 */
public class AcideHideDetailsTableMenuItemAction implements ActionListener{
