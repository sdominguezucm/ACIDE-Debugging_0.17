...
/**
 * ACIDE - A Configurable IDE close database panel table pop up menu item action.
 * 
 * @version 0.16
 * @see ActionListener
 */
public class AcideConstraintDefinitionMenuItemAction implements ActionListener{
