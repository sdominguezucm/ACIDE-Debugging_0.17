 ...
 * @see ActionListener
 */
public class AcideDataViewQuickFilterMenuItemListener implements ActionListener {

	/**
	 * ACIDE - DataView to quick filter
	 */
	private AcideDatabaseDataView _table;
	
	public AcideDataViewQuickFilterMenuItemListener(AcideDatabaseDataView table) {
		this._table = table;
	}
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if(row>=0 && col>0){
			...
			if(dataFilter.equals("")) dataFilter = "^\\z"; 	
