 ...
 * @see ActionListener
 */
public class AcideDataViewSearchMenuItemListener implements ActionListener {

	/**
	 * ACIDE - DataView to search data
	 */
	private AcideDatabaseDataView _table;
	
	public AcideDataViewSearchMenuItemListener(AcideDatabaseDataView table) {
		this._table = table;
	}
