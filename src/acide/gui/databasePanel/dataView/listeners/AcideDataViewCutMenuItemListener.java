 ...
 * @see ActionListener
 */
public class AcideDataViewCutMenuItemListener implements ActionListener {

	/**
	 * ACIDE - DataView to cut data
	 */
	private AcideDatabaseDataView _table;
	
	public AcideDataViewCutMenuItemListener(AcideDatabaseDataView table) {
		this._table = table;
	}
