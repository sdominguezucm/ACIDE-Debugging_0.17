 ...
 * @see ActionListener
 */
public class AcideDataViewReplaceMenuItemListener implements ActionListener {
	...
	public AcideDataViewReplaceMenuItemListener(AcideDatabaseDataView table) {
		this._table = table;
	}
	...
	public void actionPerformed(ActionEvent actionEvent) {
		AcideDataViewReplaceWindow.getInstance().setDataView(_table);
		AcideDataViewReplaceWindow.getInstance().setVisible(true);
	}
}
