...
public class AcideProgressWindow extends JFrame {
	...
	/**
	 * Sets the initial text of the ACIDE - A Configurable IDE progress window.
	 * 
	 * @param initialText initial text to be set.
	 */
	public void setInitialText(String initialText){
	
		// Sets the initial text
		_textPane.setText(initialText);
	}
