...
import acide.gui.menuBar.configurationMenu.fileEditor.gui.AcideFileEditorPreferencesWindow;
...
public class AcideGUIFactory {
	...
	/**
	 * Builds the ACIDE - A Configurable IDE graph panel.
	 * 
	 * @return the ACIDE - A Configurable IDE graph panel.
	 * @see AcideGraphPanel
	 */
	public AcideGraphPanel buildAcideGraphPanel() {
		return new AcideGraphPanel();
	}
	
	/**
	 * Builds the ACIDE - A Configurable IDE debug panel.
	 * 
	 * @return the ACIDE - A Configurable IDE debug panel.
	 * @see AcideDebugPanel
	 */
	public AcideDebugPanel buildAcideDebugPanel() {
		return new AcideDebugPanel();
	}
	...
	/**
	 * Build the ACIDE - A Configurable IDE menu new configuration window.
	 * 
	 * @param forModify
	 *            indicates if the menu new configuration window has to be used to
	 *            modify the menu new configuration or not.
	 * @return the ACIDE - A Configurable IDE menu new configuration window.
	 * @see AcideMenuNewConfigurationWindow
	 */
	public AcideMenuNewConfigurationWindow buildAcideMenuNewConfigurationWindow(
			boolean forModify) {
		return	AcideMenuNewConfigurationWindow.getInstance(forModify);
				//new AcideMenuNewConfigurationWindow(forModify);
	}
	...
	/**
	 * Builds the ACIDE - A Configurable IDE file editor preferences window.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor preferences
	 *         window.
	 * @see AcideFileEditorPreferencesWindow
	 */
	public AcideFileEditorPreferencesWindow buildAcideFileEditorPreferencesWindow() {
		return new AcideFileEditorPreferencesWindow();
	}
	
	/**
	 * Builds the ACIDE - A Configurable IDE database panel.
	 * 
	 * @return the ACIDE - A Configurable IDE database panel.
	 * @see AcideDataBasePanel
	 */
	public AcideDataBasePanel buildAcideDataBasePanel() {
		return new AcideDataBasePanel();
	}
}
