...
public class AcideFileEditorConfiguration {
	...
	/**
	 * ACIDE - A Configurable IDE file editor configuration send to console confirmation
	 * active.
	 */
	private boolean _sendToConsoleConfirmation;

	/**
	 * ACIDE - A Configurable IDE file editor configuration set tab size.
	 */
	private int _tabSize;
	
	/**
	 * ACIDE - A Configurable IDE file editor configuration spaces in place of TAB selected.
	 */
	private boolean _spaceSelected;
	...
	public AcideFileEditorConfiguration() {
		...
		// The send to console confirmation is activated
		_sendToConsoleConfirmation = true;

		// Sets the maximum lines to send to the console
		_maximumLinesToConsole = 30;
		
		//Sets the default value of tab
		_tabSize = 8;
		
		//TAB's are used by default
	...
	/**
	 * Returns the ACIDE - A Configurable IDE file editor configuration send to 
	 * console confirmation flag.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor configuration send to console
	 * 		confirmation flag.
	 */
	public boolean getSendToConsoleConfirmation(){
		return _sendToConsoleConfirmation;
	}
	...
	/**
	 * Sets a new value to the ACIDE - A Configurable IDE file editor
	 * configuration send to console confirmation flag.
	 * 
	 * @param sendToConsoleConfirmation
	 *            new value to set.
	 */
	public void setSendToConsoleConfirmation(boolean sendToConsoleConfirmation) {
		_sendToConsoleConfirmation = sendToConsoleConfirmation;
	}
	...
	/**
	 * Returns the ACIDE - A Configurable IDE file editor configuration
	 * spaces selected instead of tab boolean value.
	 * 
	 * @return the ACIDE - A Configurable IDE file editor configuration
	 *         spaces selected instead of tab.
	 */
	public boolean isSpaceSelected() {
		return _spaceSelected;
	}

	/**
	 * Sets a new boolean value to the ACIDE - A Configurable IDE file editor
	 * configuration spaces selected instead of tab.
	 * 
	 * @param spaceSelected
	 *            new value to set.
	 */
	public void setSpaceSelected(boolean spaceSelected) {
		_spaceSelected = spaceSelected;
	}
}
