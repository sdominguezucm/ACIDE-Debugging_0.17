...
public class AcideLexiconAssignerConfiguration {
	...
	public AcideLexiconAssignerConfiguration() {
		...
		// Sets the console lexicon configuration by default
		_consoleLexiconConfiguration = AcideLexiconConfiguration.DEFAULT_PATH
				+ AcideLexiconConfiguration.DEFAULT_NAME;
		
		// Sets the apply to console flag by default
		_applyLexiconToConsole = false;
	}
