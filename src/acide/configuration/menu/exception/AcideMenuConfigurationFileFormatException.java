 ...
 */
package acide.configuration.menu.exception;
 ...
 * @see Exception
 */
public class AcideMenuConfigurationFileFormatException extends Exception {
	 ...
	 *            error message.
	 */
	public AcideMenuConfigurationFileFormatException(String message) {
		super(message);
	}
}
