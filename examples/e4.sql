...
--   e4trust.sql (u trusted: non-valid w.r.t new u)
/abolish
/multiline on
/development on
...
-- /debug_sql v trust_tables(no) trust_file('examples/e4trust')
-- /debug_sql v trust_tables(no) trust_file('examples/e4trust2')
